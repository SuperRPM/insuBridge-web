    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="w-full px-4">
        ...
        <div className="space-y-12">
          ...
          {/* 주요 특징 섹션 */}
          <section className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold mb-6 text-blue-800">주요 특징</h2>
          ...
          {/* 분석 프로세스 섹션 */}
          <section className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold mb-6 text-blue-800">분석 프로세스</h2>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-blue-600">보험 분석 신청</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-blue-600">전문가 분석</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-blue-600">맞춤형 제안</h3>
